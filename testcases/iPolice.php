...
class iPolice extends scenario {
   ...
   function __construct($driver) {
	...
	public function Login() {
		...
		$this->driver->wait()->until(Facebook\WebDriver\WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::cssSelector("input#mdpUtilisateur")))->sendKeys("SInfocom94");
