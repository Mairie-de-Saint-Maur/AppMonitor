...
class Agora_27 extends scenario {
   ...
   public function gohome() {
      ...
      $driver->get('http://10.50.0.8/agora');
   }
   ...
   public function Action() {
      ...
      $driver->wait()->until(WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::linkText('FAMILLES - FOYERS')));
      $driver->findElement(WebDriverBy::linkText('FAMILLES - FOYERS'))->click();

      $driver->wait()->until(WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::linkText('Recherche')));
      $driver->findElement(WebDriverBy::linkText('Recherche'))->click();
   }
